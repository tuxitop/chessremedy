...
- Dependencies: Feature 011 (puzzle source), Feature 012 (solve interaction + attempt rows); consumers Features 014/015 (and Feature 016 for deletion tombstones). Feature 013 owns the canonical cycle metric function and the canonical mastery/pool derivation (`masteryOf`, `formWoodpeckerBlock`) reused by Feature 014.
