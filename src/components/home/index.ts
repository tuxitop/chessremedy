/**
 * Feature 018 — Home components barrel.
 *
 * Presentational regions composed by `HomePage`. Every value is passed in
 * already resolved; no component computes a statistic or starts an engine.
 */
...
export type { HomeStatsGridProps } from './HomeStatsGrid';
